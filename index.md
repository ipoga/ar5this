...
[ar5this](javascript:(function(){if (document.location.contains('arxiv')){document.location=loc.replace('arxiv','ar5iv');}}).call(this);)

[ar5test]([ar5this](javascript:(loc=window.location;alert(loc);))
